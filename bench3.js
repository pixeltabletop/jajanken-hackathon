...
const SYSTEM = 'Extract medical-equipment observations from the field note into the required JSON. Use null when a value is not stated. Never invent values. Do not output an entry for equipment that was not observed.';
